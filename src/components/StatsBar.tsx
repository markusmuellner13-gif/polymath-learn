...
export default function StatsBar({ userData, onSettings }: Props) {
  ...
  return (
    <div className="safe-area-top-pad sticky top-0 z-50 bg-[#0A0A1B]/90 border-b border-white/10 backdrop-blur-md">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-xs text-white/30">· {xpToNext} to lvl up</span>
            </div>
